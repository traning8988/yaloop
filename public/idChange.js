...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("today").addEventListener("click", recallSelectData);
  });
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("yesterday").addEventListener("click", recallSelectData);
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("db-yesterday").addEventListener("click", recallSelectData);
  });
